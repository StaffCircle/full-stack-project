...
### Solution
1. Api Project
A dotnet core api project being used to host a restful api.
2. UI Website
A vuejs single page application being used to host the user interface.
3. Api Test Project
A xUnit test project used to test the Api Project.
